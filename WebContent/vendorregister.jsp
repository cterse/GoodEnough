...
<html>
	...
	<script>
		...
		function getUser()
		{
			...
			if(user=="customer"){window.location("register.jsp");}
			else if(user=="vendor"){window.location("vendorregister.jsp");}
		}
	...
	<div class="regform" id="regform">
			...
			<fieldset>
				...
				<legend>Registration Form:Vendor</legend>
		...
		<option value="vendor" selected>Vendor</option>
			...
			Enter Password:<input type="password" name="password" id="pword"  required><span id="msg"></span><br><br>
			Confirm Password:<input type="password" name="confirm_password" id="confpword" onBlur="validate()" required><br><br>
